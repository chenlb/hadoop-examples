...
public class TaskAttemptUnsuccessfulCompletion extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<TaskAttemptUnsuccessfulCompletion> ENCODER =
      new BinaryMessageEncoder<TaskAttemptUnsuccessfulCompletion>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<TaskAttemptUnsuccessfulCompletion> DECODER =
      new BinaryMessageDecoder<TaskAttemptUnsuccessfulCompletion>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<TaskAttemptUnsuccessfulCompletion> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<TaskAttemptUnsuccessfulCompletion>(MODEL$, SCHEMA$, resolver);
  }
