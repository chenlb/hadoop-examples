...
public class TaskFailed extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<TaskFailed> ENCODER =
      new BinaryMessageEncoder<TaskFailed>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<TaskFailed> DECODER =
      new BinaryMessageDecoder<TaskFailed>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<TaskFailed> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<TaskFailed>(MODEL$, SCHEMA$, resolver);
  }
