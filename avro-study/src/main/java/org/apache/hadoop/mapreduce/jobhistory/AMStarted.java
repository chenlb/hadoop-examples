...
public class AMStarted extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<AMStarted> ENCODER =
      new BinaryMessageEncoder<AMStarted>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AMStarted> DECODER =
      new BinaryMessageDecoder<AMStarted>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<AMStarted> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AMStarted>(MODEL$, SCHEMA$, resolver);
  }
